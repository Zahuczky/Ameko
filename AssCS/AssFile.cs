...
public class AssFile
{
    ...
    public List<AssExtra> ScriptExtradata { get; private set; }
    ...
    public AssFile(AssInfo scriptInfo, List<AssStyle> styles, List<AssEvent> events, AssMeta scriptMetadata, List<AssExtra> scriptExtradata)
    {
